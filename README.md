...
> **Salt okunur:** Agent yalnızca analiz eder ve önerir; Meta üzerinde hiçbir
> değişiklik yapmaz. Aksiyonu (reklam kapatma, bütçe değiştirme) siz uygularsınız.

---

## Özellikler

Agent sohbet içinde 17 araç kullanır:
...
- Agent **salt okunurdur**; Meta üzerinde değişiklik yapmaz.
